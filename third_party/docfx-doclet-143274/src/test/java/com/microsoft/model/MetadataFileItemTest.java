...
public class MetadataFileItemTest {
  ...
  public void testEquals() {
    ...
    assertThat(
        "Should not be equal to object with another uid", object1.equals(object2), is(false));
  ...
  public void setTypeParameters() {
    ...
    assertThat(
        "Wrong typeParameters value", object.getSyntax().getTypeParameters(), is(typeParams));
  }
  ...
  public void getIsExternal() {
    assertThat(
        "Wrong isExternal when null",
        (new MetadataFileItem("123")).getIsExternal(),
        is(nullValue()));
    assertThat(
        "Wrong isExternal when true",
        (new MetadataFileItem("123", "name", true)).getIsExternal(),
        is(true));
    assertThat(
