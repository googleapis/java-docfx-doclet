...
public class LookupContextTest {
  ...
  public void resolve() {
    ...
    assertThat(
        "Wrong value for local key 1", lookupContext.resolve(localKeys[0]), is(localValues[0]));
    assertThat(
        "Wrong value for local key 2", lookupContext.resolve(localKeys[1]), is(localValues[1]));
