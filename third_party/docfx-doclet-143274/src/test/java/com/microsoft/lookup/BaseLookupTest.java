...
public class BaseLookupTest {
  ...
  public void testExtractMethods() {
    ...
    assertEquals(
        ...
        lastBuiltItem.getPackageName());
    assertEquals(
        "Wrong fullName", baseLookup.extractFullName(element), lastBuiltItem.getFullName());
    ...
    assertEquals(
        ...
        lastBuiltItem.getFieldContent());
    assertEquals(
        "Wrong constructorContent",
        baseLookup.extractConstructorContent(element),
        lastBuiltItem.getConstructorContent());
    assertEquals(
        "Wrong overload", baseLookup.extractOverload(element), lastBuiltItem.getOverload());
    assertEquals(
        "Wrong parameters", baseLookup.extractParameters(element), lastBuiltItem.getParameters());
    assertEquals(
        "Wrong exceptions", baseLookup.extractExceptions(element), lastBuiltItem.getExceptions());
    ...
    assertEquals(
        "Wrong superclass", baseLookup.extractSuperclass(element), lastBuiltItem.getSuperclass());
    assertEquals(
        "Wrong interfaces", baseLookup.extractInterfaces(element), lastBuiltItem.getInterfaces());
    assertEquals("Wrong tocName", baseLookup.extractTocName(element), lastBuiltItem.getTocName());
    assertEquals(
        "Wrong references", baseLookup.extractReferences(element), lastBuiltItem.getReferences());
  }
