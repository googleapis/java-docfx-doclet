...
public class YamlUtilTest {
  ...
  private MetadataFileItem buildMetadataFileItem(int seed) {
    ...
    metadataFileItem.setParameters(
  ...
  public void cleanupHtmlIncludePrettyPrintTest() {
    ...
    assertFalse(
        YamlUtil.cleanupHtml("<pre>" + random + "<code>")
  ...
  public void cleanupHtmlEqualTitlesTest() {
    ...
    assertEquals(
        ...
        "=======================SpeechClient=======================");
    assertEquals(
        "\"scikit-learn\":\"==0.19.0\"TextTextText\"botocore\":\"==1.7.14\"",
        "\"scikit-learn\":\"==0.19.0\"TextTextText\"botocore\":\"==1.7.14\"");
    assertEquals(
        "======= test1234 ===== 1234test === 1234test1234 == test =",
        YamlUtil.cleanupHtml("======= test1234 ===== 1234test === 1234test1234 == test ="));
    assertEquals(
  ...
  public void cleanupHtmlReferenceTest() {
    ...
    String expectedResult =
        "<xref uid=\"google.cloud.kms.v1.KeyRing\" data-throw-if-not-resolved=\"false\">KeyRing</xref>";
    String random = UUID.randomUUID().toString();
  ...
  public void cleanupHtmlLinkTagWithLinkTest() {
    ...
    String expectedResult =
        "<a href=\"http://www.bad-way-to-include-link.com#section\">http://www.bad-way-to-include-link.com#section</a>";
    String random = UUID.randomUUID().toString();
  ...
  public void cleanupHtmlLinkTagNotRecognizedTest() {
    ...
    String expectedResult =
        "<xref uid=\"WeirdLink#didntResolve(null)\" data-throw-if-not-resolved=\"false\">WeirdLink#didntResolve(null)</xref>";
    String random = UUID.randomUUID().toString();
