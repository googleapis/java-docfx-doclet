...
public class RepoMetadataTest {
  ...
  public void testParseRepoMetadata() {
    ...
    assertEquals(
        ...
        testRepoMetadata.getRestDocumentationUri());
    assertEquals(
        "https://cloud.google.com/translate/docs/reference/rpc",
        testRepoMetadata.getRpcDocumentationUri());
    assertEquals(
    ...
    assertEquals(
        "https://cloud.google.com/java/docs/reference/google-cloud-translate/latest/overview",
        testRepoMetadata.getClientDocumentationUri());
    ...
    assertEquals(
        ...
        testRepoMetadata.getGithubLink());
    assertEquals(
        "https://central.sonatype.com/artifact/com.google.cloud/google-cloud-translate",
        testRepoMetadata.getMavenLink());
  }
}
