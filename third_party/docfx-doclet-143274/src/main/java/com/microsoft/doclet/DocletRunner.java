...
/**
 * To use runner just pass as commandline param to main method: - name of file with doclet name amd
 * params
 *
 * <p>For example: java DocletRunner src\test\resources\test-doclet-params.txt
 */
public class DocletRunner {
  ...
  public static void main(final String[] args) {
    ...
    ToolProvider.getSystemDocumentationTool()
        .run(null, null, null, OptionsFileUtil.processOptionsFile(args[0]));
  }
}
