...
public class TocFile extends ArrayList<TocItem> implements YmlFile {
  ...
  public TocFile(String outputPath, String projectName, boolean disableChangelog, boolean disableLibraryOverview) {
  ...
  public String getFileContent() {
    sortByUid();
    List<Object> tocContents = new TocContents(projectName, disableChangelog, disableLibraryOverview, this).getContents();
